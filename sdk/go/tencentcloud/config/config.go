...
func GetRegion(ctx *pulumi.Context) string {
	...
	if dv, ok := getEnvOrDefault("", nil, "TENCENTCLOUD_REGION", "TENCENTCLOUD_DEFAULT_REGION").(string); ok {
		return dv
	}
	return v
}
...
func GetSecretId(ctx *pulumi.Context) string {
	...
	if dv, ok := getEnvOrDefault("", nil, "TENCENTCLOUD_SECRET_ID", "tencentcloud_secret_id").(string); ok {
		return dv
	}
	return v
}
...
func GetSecretKey(ctx *pulumi.Context) string {
	...
	if dv, ok := getEnvOrDefault("", nil, "TENCENTCLOUD_SECRET_KEY", "tencentcloud_secret_key").(string); ok {
		return dv
	}
	return v
}
...
func GetSecurityToken(ctx *pulumi.Context) string {
	return config.Get(ctx, "tencentcloud:securityToken")
}
